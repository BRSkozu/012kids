...
export const GAKUDO_DATA: GakudoWardData[] = [
  ...
  },
  {
    ward: '文京区',
    wardSlug: 'bunkyo',
    programName: '育成室（学童クラブ）',
    modelType: 'standard',
    officialUrl: 'https://www.city.bunkyo.lg.jp/',
    notes: '公式で要確認。教育環境への関心が高い区',
  },
  {
    ward: '台東区',
    wardSlug: 'taito',
  ...
  },
  {
    ward: '江東区',
    wardSlug: 'koto',
    programName: '学童クラブ ＋ 江東きっずクラブ',
    modelType: 'hybrid',
    officialUrl: 'https://www.city.koto.lg.jp/',
    notes: '公式で要確認。湾岸エリアは需要増傾向',
  },
  {
    ward: '品川区',
    wardSlug: 'shinagawa',
