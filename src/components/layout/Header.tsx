      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-1">
            {AGE_STAGES.map((stage) => (
              <Link
                ...
                className="px-3 py-2 text-sm font-medium rounded-lg hover:bg-orange-50 transition-colors"
          ...
          <button
            ...
            className="md:hidden p-2 text-gray-500 hover:text-[var(--color-primary)]"
            aria-label="メニュー"
        ...
        {/* Mobile Navigation */}
        {menuOpen && (
          <nav className="md:hidden pb-4 border-t border-orange-100 pt-4">
            <div className="space-y-1">
              ...
              {AGE_STAGES.map((stage) => (
                <Link
                  ...
                  className="flex items-center px-3 py-2 text-sm rounded-lg hover:bg-orange-50"
                >
                  <span
            ...
            <div className="mt-4 pt-4 border-t border-orange-100 space-y-1">
              <Link href="/articles" onClick={() => setMenuOpen(false)} className="block px-3 py-2 text-sm rounded-lg hover:bg-orange-50">
                記事一覧
              </Link>
              <Link href="/search" onClick={() => setMenuOpen(false)} className="block px-3 py-2 text-sm rounded-lg hover:bg-orange-50">
                検索
              </Link>
              ...
              <Link href="/editorial-policy" onClick={() => setMenuOpen(false)} className="block px-3 py-2 text-sm rounded-lg hover:bg-orange-50">
                編集方針
              </Link>
              <Link href="/contact" onClick={() => setMenuOpen(false)} className="block px-3 py-2 text-sm rounded-lg hover:bg-orange-50">
                お問い合わせ
              </Link>
            </div>
          </nav>
