  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose-like space-y-8 text-gray-700 text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-3">2. アクセス解析ツールについて</h2>
          <p>
          ...
          <p className="mt-2">
            ...
            <a href="https://marketingplatform.google.com/about/analytics/terms/jp/" target="_blank" rel="noopener noreferrer" className="text-[var(--color-primary)] hover:underline">Google アナリティクス利用規約</a>
            をご参照ください。
          </p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-3">3. Cookieについて</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-3">4. 個人情報の利用目的</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-3">6. 個人情報の安全管理</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-3">7. お子さまの個人情報について</h2>
          <p>
